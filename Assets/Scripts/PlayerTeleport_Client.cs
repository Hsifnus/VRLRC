...
public class PlayerTeleport_Client : Photon.PunBehaviour, IPunCallbacks
{
    ...
    {
        Debug.Log("OnPhotonInstantiate 2");
        cameraHolder = GameObject.FindGameObjectsWithTag("MainCamera")[0];
        spawnPoint = GameObject.FindGameObjectsWithTag("BaseCameraRig")[0];
